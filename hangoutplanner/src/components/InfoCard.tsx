function InfoCard() {
  return (
    <div className=" grid lg:justify-between lg:grid-cols-2 lg:grid-rows-[auto_1fr] bg-[#FFFFFF] ">
      <p className="order-1 lg:order-0 lg:col-start-1 lg:row-start-1 font-bold text-h1 mb-5">
      ...
      >
        <img
          className="block w-full lg:max-w-150 lg:max-h-100"
